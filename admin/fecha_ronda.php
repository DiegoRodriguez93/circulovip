 ...
 <!-- MODAL CAMBIAR FECHA END -->
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <table id="TableFechas" class="display table text-center" style="width: 100%">
        <thead>
            <tr>
        <th>Fecha</th>
        <th>Eliminar</th>
        ...
        <tbody></tbody>
          ...
          <div class="text-center my-5">
            <h3>Formulario de ingreso fecha de ronda</h3>
          </div>

          <label for="">Dia de ronda</label>
          <input type="date" class="form-control" name="fecha" id="fecha">

          <br>

          <div class="text-center my-3">
              <input type="submit" onclick="ingresarFecha()" class="btn btn-success btn-lg" value="Ingresar Fecha">
          </div>
