...
// TIPO DE HORARIO 1 ES AGREGADO O HABILITADO PARA ESE DIA DE CITA
...
if(mysqli_num_rows($select) > 0){
    ...
    $update = mysqli_query($mysqli,"UPDATE horarios_personalizados SET tipo = 1 WHERE id = '$id' ");

    if($update){
        $res = array('result'=>true,'message'=>'Horario agregado correctamente');
    }else{
